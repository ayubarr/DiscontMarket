document.addEventListener('DOMContentLoaded', () => {
    ...
    // Привязываем события
    minSlider.addEventListener('mouseup', handleSliderInput);
    maxSlider.addEventListener('mouseup', handleSliderInput);
    minPriceInput.addEventListener('mouseup', () => {
        updateSlidersFromInputs(); // Синхронизация слайдеров
        updateFiltersInURL(); // Обновление URL
    });
    maxPriceInput.addEventListener('mouseup', () => {
        updateSlidersFromInputs(); // Синхронизация слайдеров
        updateFiltersInURL(); // Обновление URL
    });
