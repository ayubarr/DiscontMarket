        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstName = table.Column<string>(type: "varchar", maxLength: 50, nullable: true),
                    LastName = table.Column<string>(type: "varchar", maxLength: 50, nullable: true),
                    MiddleName = table.Column<string>(type: "varchar", maxLength: 50, nullable: true),
                    UserName = table.Column<string>(type: "varchar", maxLength: 50, nullable: true),
                    NormalizedUserName = table.Column<string>(type: "varchar", maxLength: 50, nullable: true),
                    Email = table.Column<string>(type: "varchar", maxLength: 50, nullable: true),
                    NormalizedEmail = table.Column<string>(type: "varchar", maxLength: 50, nullable: true),
                    EmailConfirmed = table.Column<bool>(type: "boolean", nullable: false),
                    PasswordHash = table.Column<string>(type: "varchar", maxLength: 50, nullable: true),
                    SecurityStamp = table.Column<string>(type: "varchar", maxLength: 50, nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "varchar", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TagName = table.Column<string>(type: "varchar", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    CreationDate = table.Column<DateTime>(type: "timestamp(2) without time zone", nullable: false),
                    Condition = table.Column<int>(type: "integer", nullable: false),
                    TotalCost = table.Column<decimal>(type: "numeric(15,2)", precision: 15, scale: 2, nullable: false),
